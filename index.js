// NFT setup
const nftCa = "0xC995199DC53922caCE4f6ac14A476eF8c9429387";
const pathToPngs = 'https://raw.githubusercontent.com/NftClubCash/PixelGuyClub/main/png/';
...
function appendNft(nft, showPicture, auctionStatus) {
  ...
  htmlString +=
    `<div class="card-body">
        ...
        <span><b>Clothing</b>: `+ nft.traits.Clothing + ` (` + categories.Clothing[nft.traits.Clothing] + `%)</span><br>
        ...
        <span><b>Head</b>: `+ nft.traits.Head + ` (` + categories.Head[nft.traits.Head] + `%)</span><br>
        <span><b>Headgear</b>: `+ nft.traits.Headgear + ` (` + categories.Headgear[nft.traits.Headgear] + `%)</span><br>
        <span><b>Skin</b>: `+ nft.traits.Skin + ` (` + categories.Skin[nft.traits.Skin] + `%)</span><br>
...
async function loadPicture(nftId) {
  $("#nftPic-" + nftId).html(`<img src="` + pathToPngs + nftId + `.png" width="250px">`);
}
...
function showFilterSettings() {
  ...
  filters.Skin = getSelectValues(document.getElementById("Skin"));
  filters.Clothing = getSelectValues(document.getElementById("Clothing"));
  ...
  filters.Headgear = getSelectValues(document.getElementById("Headgear"));
  ...
  if ("" != filters.Skin) filterSettings += "<b>Skin</b>: " + filters.Skin + " ";
  if ("" != filters.Clothing) filterSettings += "<b>Clothing</b>: " + filters.Clothing + " ";
  if ("" != filters.Eyes) filterSettings += "<b>Eyes</b>: " + filters.Eyes + " ";
  if ("" != filters.Mouth) filterSettings += "<b>Mouth</b>: " + filters.Mouth + " ";
  if ("" != filters.Head) filterSettings += "<b>Head</b>: " + filters.Head + " ";
  if ("" != filters.Headgear) filterSettings += "<b>Headgear</b>: " + filters.Headgear + " ";
